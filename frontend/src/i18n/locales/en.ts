export default {
  ...
  desktopCodex: {
    ...
    guidedTitle: 'Download Codex, then write the config',
    guidedDescription: 'The codex group and an available key are selected automatically. Download Codex first, then click “Write Codex Config”.',
    ...
    downloadCodex: 'Download Codex',
    downloadHint: 'Install Codex Desktop, then return here',
    ...
    autoSelectedGroup: 'Auto-selected Group',
    autoSelectedKey: 'Auto-selected Key',
    refreshSetup: 'Refresh Auto Selection',
    advancedSettings: 'Advanced Settings',
    advancedSettingsHint: 'Usually leave this closed. Expand only to switch servers or choose a key manually.',
    notReady: 'Not ready',
    willCreateKey: 'A Codex Desktop key will be created on write',
    autoCreateKeyShort: 'No key found. One will be created on write.',
    needDesktop: 'Use this in Sub2API Desktop',
    needOpenaiGroup: 'No available OpenAI/codex group found',
    autoCreateKeyHint: 'Creates a key automatically and writes ~/.codex',
  ...
  dashboard: {
    ...
    spendingRanking: 'User Spending Ranking',
    top10Users: 'Top 10 users',
    you: 'You',
    noRankingData: 'No ranking data',
    rankingDataHint: 'There are no user spending records in this time range.',
